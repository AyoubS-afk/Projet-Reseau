...
class WelcomeScreen(arcade.View):
    ...
    def __init__(self):
        ...
        self.logo = arcade.load_texture(
            constantes.SPRITE_PATH + "Screens/C3title_00001.png")
        self.background = arcade.load_texture(
            constantes.SPRITE_PATH + "Screens/0_fired_00001.png")
        arcade.set_background_color(arcade.color.AMAZON)

        self.buttons_manager = arcade.gui.UIManager()
        self.newgame_button = but.NewGameButton(
            x=constantes.MIDDLE[0]-100, y=constantes.MIDDLE[1]+40+15+7.5, texture=but.texture_panel11, my_text="New Game", width=200, height=40, color="black")
        self.load_button = but.LoadGameButton(
            x=constantes.MIDDLE[0]-100, y=constantes.MIDDLE[1]+7.5, texture=but.texture_panel11, my_text="Load Game", width=200, height=40, color="black")
        self.settings_button = but.SettingButton(
            x=constantes.MIDDLE[0]-100, y=constantes.MIDDLE[1]-40-7.5, texture=but.texture_panel11, my_text="Settings", width=200, height=40, color="black")
        self.quit_button = but.QuitButton(x=constantes.MIDDLE[0]-100, y=constantes.MIDDLE[1]-80-15 -
                                          7.5, texture=but.texture_panel11, my_text="Leave Game", width=200, height=40, color="black")
        self.newgame_button.on_click = self.replace_on_click
    ...
    def on_draw(self):
        ...
        if self.manager._enabled:
            arcade.draw_texture_rectangle(
                center_x=180+200, center_y=constantes.MIDDLE[1], width=350, height=200, texture=but.texture_panel1)
            arcade.draw_texture_rectangle(
                center_x=180+200, center_y=constantes.MIDDLE[1]+40, width=320, height=20, texture=but.texture_panel46)
            self.manager.draw()
